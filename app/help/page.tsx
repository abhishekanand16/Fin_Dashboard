...
const FinancialFeaturesFAQ = memo(function FinancialFeaturesFAQ() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
...
const GoalsProgressFAQ = memo(function GoalsProgressFAQ() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
...
const AnalyticsReportsFAQ = memo(function AnalyticsReportsFAQ() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
...
const SettingsCustomizationFAQ = memo(function SettingsCustomizationFAQ() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
...
const TroubleshootingFAQ = memo(function TroubleshootingFAQ() {
  return (
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
